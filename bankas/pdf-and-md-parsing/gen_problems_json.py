...
def parse_md(md_file):
    ...
    for i in range(0, len(sections), 2):
        ...
        formatted_text = formatted_text.replace("é", "ė").replace("è", "ė").replace("ê", "ė").replace("ë", "ė").replace("ē", "ė").replace("ị", "į").replace("ě", "ė").replace("İ", "Į").replace("ị", "į").replace("ị", "į").replace("ì", "į").replace("ě", "ė").replace("è", "ė").replace("é", "ė").replace("ụ", "ė")
